...
class TestHelpers:
    ...
    def test_extract_hazard_codes(self):
        ...
        # Simple case
        assert extract_hazard_codes("H315: Causes skin irritation") == {
        ...
        # Combined codes
        assert extract_hazard_codes("H315+H319: Causes skin and eye irritation") == {
    ...
    def test_extract_precautionary_codes(self):
        ...
        # Simple case
        assert extract_precautionary_codes("P210: Keep away from heat") == {
    ...
    def test_normalize_chemical_name(self):
        ...
        assert (
            normalize_chemical_name("2,2'-Dichlorodiethyl ether")
            == "2 2 dichlorodiethyl ether"
        )

        # Remove extra whitespace
        assert (
            normalize_chemical_name("Methyl  ethyl   ketone") == "methyl ethyl ketone"
        )
    ...
    def test_validate_chemical_data(self):
        ...
        invalid_data = {"name": "Acetone", "formula": "C3H6O", "xlogp": "not a number"}
        is_valid, errors = validate_chemical_data(invalid_data)
        assert is_valid is False
